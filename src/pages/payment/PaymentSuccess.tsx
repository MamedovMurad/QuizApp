  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-green-50 to-green-100 px-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold mb-2 text-gray-800">Ödəniş uğurla tamamlandı</h1>
        <p className="text-gray-600 mb-6">
          Təşəkkür edirik! Ödənişiniz uğurla həyata keçirildi. İndi siz paketdən tam istifadə edə bilərsiniz.
        </p>
        <Button
          type="primary"
